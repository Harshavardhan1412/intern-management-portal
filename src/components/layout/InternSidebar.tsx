...
import {
  LayoutDashboard, ClipboardCheck, ListChecks, FolderKanban,
  Users, CalendarOff, Megaphone, UserCircle, LogOut,
} from 'lucide-react'
    ...
    <aside className="fixed left-0 top-0 h-screen w-64 bg-navy text-white flex flex-col z-30">
      <div className="px-6 py-5 border-b border-navy-light">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <span className="block text-xs text-slate-400 -mt-0.5">Intern Platform</span>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-4 border-t border-navy-light">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-9 h-9 rounded-full bg-navy-light flex items-center justify-center text-xs font-medium">
            {user?.initials ?? '?'}
          </div>
